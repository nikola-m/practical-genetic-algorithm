...
!
! Date 3 July 2003
! Programmer Jaymon Knight
! Description of Changes Code based on seudocode
! ===========================================
!
! 19 Nov 2003
! Sue Haupt
! Revised for 2nd ed of Haupt and Haupt
!
! June 2017
! Nikola Mirkov
! Edit for "ordinary" fortran from HPF version.
!
!
USE funct
USE qsort_c_module
  ...
  INTEGER::bad_sort  ! Counts number of bad !sorts from hpf grade_up
...
!Finds the size of array expected by subroutine
...
!Cost in order stored in order stored in ind
...
enddo
odds(2:keep+1)=odds_tmp(2:keep+1)
...
! HPC function for sorting ind2=grade_up(mrow,DIM=1) 
! mrow=mrow(ind2) We don't need ind2 any more.
call QsortCInt(mrow)
...
CALL RANDOM_NUMBER(temp_arr_1)
temp_arr_1=(hi-lo)*temp_arr_1+lo !between hi & lo
